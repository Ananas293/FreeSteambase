const games = [
    {
		...
		altName: "Симулятор электрика Electrician Simulator",
		users:[
			{
				login:'1IG9R6IWO',
				pass:'324431ewqw11',
		...
		altName: "Омси 2 OMSI 2: Steam Edition",
		users:[
			{
				login:'sebastian_msv',
				pass:'2gD3C7tv7qZR',
		...
		altName: "Догма Дракона 2 Dragon's Dogma 2",
		users:[
			{
				login:'dragonsssdogma2',
				pass:'Sd2b345734',
			},
			{
				login:'mksir82042',
		...
		altName: "Резидент Евил 4 Resident Evil 4",
		users:[
			{
				login:'guzzzlightyearr',
				pass:'Sd2b345734',
			},
			{
				login:'gflgn72587',
		...
		appid: 782330,
		name: "Doom Eternal",
		altName: "Дум етернал Doom Eternal",
		users:[
			{
				login:'doomstar10x',
				pass:'jordan2020',
		...
		altName: "Евил гениус 2 Evil Genius 2: World Domination",
		users:[
			{
				login:'fucus7v9',
				pass:'tlqwvkln',
		...
		appid: 320240,
		name: "We Happy Few",
		altName: "ви хаппи фев We Happy Few",
		users:[
			{
				login:'emij891230',
				pass:'32rpf34o',
		...
		altName: "ви хаппи фев The Binding of Isaac: Rebirth",
		users:[
			{
				login:'wbtq1086053',
				pass:'steamok987789',
		...
		appid: 633460,
		name: "Tannenberg",
		altName: "Танненберг Tannenberg",
		users:[
			{
				login:'haidaodaheng6a',
				pass:'Hh6039516a',
			}
		]
		},{
		appid: 433340,
		name: "Slime Rancher",
		altName: "Слайм Ранчер Slime Rancher",
		users:[
			{
				login:'zlrqu394',
				pass:'sxee14752JY',
		...
		altName: "Слайм Ранчер 2 Slime Rancher 2",
		users:[
			{
				login:'dulge093',
				pass:'Leyouz6824',
		...
		altName: "Супер банни мен Super Bunny Man",
		users:[
			{
				login:'thb111912',
				pass:'steamok000',
		...
		appid: 374320,
		name: "Dark Souls III",
		altName: "Дарк соулс 3 Dark Souls III",
		users:[
			{
				login:'bnbz57548',
				pass:'zuobiao6788',
		...
		altName: "Хаус флиппер 2 House flipper 2",
		users:[
			{
				login:'ybmbl25210',
				pass:'dajy02609E',
		...
		altName: "Балгур гейт 3 Baldur's Gate 3",
		users:[
			{
				login:'gznzjmqhjepk',
				pass:'vj9sHBlFPd',
		...
		appid: 1091500,
		name: "Cyberpunk 2077",
		altName: "Киберпанк 2077 Cyberpunk 2077",
		users:[
			{
				login:'lyubomirkvach',
				pass:'iyzN!2Jb8dc',
		...
		altName: "Человек паук ремастеред спайдер мен ремастеред Marvel's Spider-Man Remastered",
		users:[
			{
				login:'urng10607',
				pass:'zuobiao7282',
		...
		altName: "ведьмак 3 The Witcher 3: Wild Hunt",
		users:[
			{
				login:'sauriora',
				pass:'0V8AJyW1BpSw',
		...
		altName: "человек паук милес моралес спайдер ман мен Marvel's Spider-Man: Miles Morales",
		users:[
			{
				login:'31771114',
				pass:'40827578',
		...
		appid: 1627720,
		name: "Lies of p",
		altName: "Лиес оф пи п Lies of p",
		users:[
			{
				login:'jyhca12624',
				pass:'jkww27020C',
		...
		altName: "Сонс оф тхе форест Sons of the forest",
		users:[
			{
				login:'88113023',
				pass:'79125992',
		...
		appid: 1029690,
		name: "Sniper elite 5",
		altName: "Снайпер елите 5 Sniper elite 5",
		users:[
			{
				login:'fd00875',
				pass:'Na840921',
		...
		altName: "Майкрософт Флайнг симулятор Microsoft Flight Simulator",
		users:[
			{
				login:'sqci120',
				pass:'1370960774zxcZ',
		...
		altName: "Мортал комбат 1 Mortal Kombat 1",
		users:[
			{
				login:'robert_7070c',
				pass:'YpBLezu4ugQ',
		...
		altName: "Супермаркет симулятор Supermarket Simulator",
		users:[
			{
				login:'51376449',
				pass:'40644485',
		...
		altName: "Хогвартс легаси Hogwarts Legacy",
		users:[
			{
				login:'mcqw42573',
				pass:'muR994uao',
		...
		altName: "Тхиев симулятор 1 вора Thief simulator ",
		users:[
			{
				login:'wbtq1089849',
				pass:'steamok1089849',
		...
		altName: "Хойка оф ирон 4 Hearts of Iron IV",
		users:[
			{
		...
		appid: 412020,
		name: "Metro Exodus",
		altName: "Метро ексодус Metro Exodus",
		users:[
			{
				login:'asdasdasd49',
				pass:'QYjz3nBDsds',
		...
		altName: "Метро 2033 Редукс Metro 2033 Redux",
		users:[
			{
				login:'asdasdasd49',
				pass:'QYjz3nBDsds',
		...
		altName: "Метро ласт лайхт Metro: Last Light Complete Edition",
		users:[
			{
				login:'asdasdasd49',
				pass:'QYjz3nBDsds',
		...
		altName: "Детроит бекоме хюман Detroit: Become Human",
		users:[
			{
				login:'cwbpp57700',
				pass:'Steamok878945',
		...
		altName: "Ситиес скайлайнес Cities: Skylines",
		users:[
			{
				login:'DSTJX41004',
				pass:'LP050777',
		...
		altName: "Ситиес скайлайнес 2 Cities: Skylines II",
		users:[
			{
				login:'93612408',
				pass:'07545306',
		...
		altName: "Сид меиерс целивизация 6 Sid Meier’s Civilization® VI",
		users:[
			{
				login:'sonofplumber',
				pass:'rXGMQyhe',
		...
		altName: "дайнг лайхт 2 стей хьюман релоад едитион Dying Light 2 Stay Human: Reloaded Edition",
		users:[
			{
				login:'zonovyqaf',
		...
		altName: "Наруто NARUTO SHIPPUDEN: Ultimate Ninja STORM 4",
		users:[
			{
				login:'hisokakarott',
				pass:'er23.22.23',
		...
		altName: "Лордс оф тхе фаллен Lords of the Fallen",
		users:[
			{
				login:'rkwoh77645',
				pass:'uofh08187V',
		...
		altName: "Кукинг симуоятор Cooking Simulator",
		users:[
			{
				login:'a591160536',
				pass:'70Games.net210',
		...
		altName: "Тхе каллисто протокол The Callisto Protocol",
		users:[
			{
				login:'iakc34962',
				pass:'muwei4z07',
		...
		appid: 1017180,
		name: "The Long Drive",
		altName: "Тхе лонг драйв The Long Drive",
		users:[
			{
				login:'njad84593',
				pass:'pGA75Rz09X',
		...
		altName: "Бакшот рулетте Buckshot Roulette",
		users:[
			{
				login:'yuewanyouxi7188',
				pass:'yuewanyouxi.ASIA',
			}
		]	
		},{
		appid: 108600,
		name: "Project Zomboid",
		altName: "Проект зомбоид Project Zomboid",
		users:[
			{
				login:'oidac943',
				pass:'f78978989',
		...
		appid: 524220,
		name: "NieR:Automata™",
		altName: "ниер айтомата NieR:Automata™",
		users:[
			{
				login:'difika1',
				pass:'xxyxi.cn/5922',
		...
		altName: "Дарк соулс ремастеред DARK SOULS™: REMASTERED",
		users:[
			{
				login:'yhc70116',
				pass:'iui65428',
		...
		altName: "секиро сшадов дие твисе готу едитион Sekiro™: Shadows Die Twice - GOTY Edition",
		users:[
			{
				login:'docmu380',
				pass:'FarXiniu03',
		...
		altName: "калл оф дюти: блек опс 2 Call of Duty®: Black Ops II",
		users:[
			{
				login:'XAVIER19601',
				pass:'BaBaBoY1',
		...
		appid: 668580,
		name: "Atomic heart",
		altName: "Атомик херт атомное сердце Atomic heart",
		users:[
			{
				login:'Maksimqb',
				pass:'Anpol2005.',
		...
		appid: 1291340,
		name: "Townscaper",
		altName: "Товнскапер Townscaper",
		users:[
			{
				login:'steamok1089793',
				pass:'steamok432234',
			}
		]	
		},{
		appid: 1062160,
		name: "Poly Bridge 2",
		altName: "Поли бридже 2 Poly Bridge 2",
		users:[
			{
				login:'steamok1089939',
				pass:'steamok567768',
			}
		]	
		},{
		appid: 699130,
		name: "World War Z",
		altName: "Ворлд вар З World War Z",
		users:[
			{
				login:'ayibh10789',
				pass:'zuobiao32874',
		...
		appid: 346010,
		name: "Besiege",
		altName: "бесиеге Besiege",
		users:[
			{
				login:'steamok1090206',
				pass:'steamok888777',
			}
		]	
		},{
		...
		altName: "Резидент евил 2 Resident Evil 2",
		users:[
			{
				login:'sauriora',
				pass:'0V8AJyW1BpSw',
		...
		altName: "волфенстеин 2 тхе нев колоссус Wolfenstein II: The New Colossus",
		users:[
			{
				login:'sauriora',
				pass:'0V8AJyW1BpSw',
		...
		appid: 202170,
		name: "Sleeping Dogs",
		altName: "слипинг догс спящая собака Sleeping Dogs",
		users:[
			{
				login:'sauriora',
				pass:'0V8AJyW1BpSw',
